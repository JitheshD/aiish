...
$formDataHrr = getHrrDetByPatient($patientId);
$formData1 = getStep2Info($_POST, $_PID);
//echo $formData1["prenatal_id"];
//echo $formData1["other_id"];
...
<div class="ui-title-page bg_title bg_transparent">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
<?php if (USERAUTH == 1) { ?><h1>Data Entry</h1><?php } else { ?><h1>Medical Officer Page</h1><?php } ?>
                <div class="ui-subtitle-page">New Born Screening Services</div>
            </div>
        </div>
    </div>
</div>
...
<section class="section-large">
    <div class="container">
        ...
        <form role="form" id="patValidate" name="birthday" action="" method="post">
                ...
                <div class="col-xs-12 " id="">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <div class="col-md-4 ">
                            ...
                            <label class="control-label"><strong>Hospital name</strong></label>
                            <select name="jelectHosp" id="jelectHosp" size="1" class="form-control" required="" onchange="copyValue()">
                        ...
                        <div id="autogen">
                            <div class="col-md-4" id="bid">
                                <!--<div class="form-group">-->
                                <label class="control-label"><strong>Baby identification no.</strong></label>
                            ...
                            <div class="col-md-4 ">
                                <!--<div class="form-group">-->
                                <label class="control-label"><strong>POCD</strong></label>
                                <!--<input  maxlength="100" type="text" required="required" class="form-control" placeholder="Enter First Name" value="<?php echo $formData1["batch_no"] ?>"  />-->
                                <input type="text" size="10" name="pocd_no" class="form-control" readonly=""  id="pocd_no" value="<?php echo $formData["POCD_No"] ?>"  >
                                <!--</div>-->
                            </div>  
                    ...
                    <div class="col-md-12 form-group">
                        <div class="col-md-4">
                            <!--<div class="form-group">-->
                            <label class="control-label"><strong>Baby Name:</strong></label>
                            <!--<input  maxlength="100" type="text" required="required" class="form-control" placeholder="Enter First Name" value="<?php echo $formData1["batch_no"] ?>"  />-->
                            <input type="text" size="10" name="babyName" class="form-control required" id="babyName" value="<?php echo $formData["Baby_name"] ?>" >
                            <!--</div>-->
                        </div>
                        
                        <div class="col-md-4 ">
                            <label class="control-label"><strong>Birth Date</strong></label>
                            <input type="text" class="form-control datetimepicker" name="birthdate" id="birthdate" onchange="getAgeByBirthDate(this.value)" value="<?php echo convertToSqlDate($formData["Date_of_Birth"]) ?>">
                        </div>
                        
                        

                        <div class="col-md-4" id="age">
                            <label  name="age"><strong>Age</strong></label>
                            <?php //$age = !empty($patientId)? "<input name='age' id='age' class='form-control' size='40' readonly='' value='{$formData["Age"]}'>":"<input name='age' id='age' class='form-control' size='40' readonly='' value=''>"; 
                             // echo $age;  
                             ?>
                            <input name="age" class="form-control" id="baby_age" size="40" readonly="" value="<?php echo convertFromSqlDate($formData["Age"]); ?>">
                    ...
                    <div class="col-md-12 form-group">
                        <div class="col-md-3">
                            <!--<div class="form-group">-->
                            <label class=""><strong>Father Name:</strong></label>
                            <!--<input  maxlength="100" type="text" required="required" class="form-control" placeholder="Enter First Name" value="<?php echo $formData1["batch_no"] ?>"  />-->
                            <input type="text" size="10" name="father" class="form-control"  id="father" value="<?php echo $formData["Father_name"] ?>" >
                            <!--</div>-->
                        </div>
                        <div class="col-md-3">
                            <!--<div class="form-group">-->
                            <label class=""><strong>Mother Name</strong></label>
                            <!--<input  maxlength="100" type="text" required="required" class="form-control" placeholder="Enter First Name" value="<?php echo $formData1["batch_no"] ?>"  />-->
                        ...
                        <div class="col-md-3">
                            <!--<div class="form-group">-->
                            <label class=""><strong>Conatct no.</strong></label>
                            <!--<input  maxlength="100" type="text" required="required" class="form-control" placeholder="Enter First Name" value="<?php echo $formData1["batch_no"] ?>"  />-->
                        ...
                        <div class="col-md-3">
                            <!--<div class="form-group">-->
                            <label class=""><strong>Email ID</strong></label>
                            <!--<input  maxlength="100" type="text" required="required" class="form-control" placeholder="Enter First Name" value="<?php echo $formData1["batch_no"] ?>"  />-->
                            <input type="email" size="10" name="email" class="form-control" id="email" value="<?php echo $formData["Email_id"] ?>" >
                            <!--</div>-->
                        </div>
                    ...
                    <div class="col-md-12 form-group">
                        <div class="col-md-4 form-group ">
                            <!--<div class="form-group">-->
                            <label class="control-label"><strong>Gender</strong></label><br>
                            <!--<input  maxlength="100" type="text" required="required" class="form-control" placeholder="Enter First Name" value="<?php echo $formData1["batch_no"] ?>"  />-->
                            ...
                            <label class="control-label radio-inline"><input type="radio" size="" name="gender" checked="" class=" " id="male" value="male"  >Male</label>
                        ...
                        <div class="col-md-2-1">
                            ...
                            <div id="statediv"><select class="form-control" name='district' id='district' onchange='getCity(<?php echo $formData["state_id"]?>,this.value)' >
                        ...
                        <div class="col-md-2-1">
                            <label class="control-label"><strong>Taluk</strong></label>

                            <div id="citydiv">
                                <select class="form-control" name="city" id="city" >
                                    <?php $city = !empty($formData["city_id"])? "".getCitySelectList($formData["city_id"])."":"<option disabled selected value>Select Taluk</option>"; ?>
                                    <?php echo $city; ?>
                    ...
                    <div class="col-md-12 form-group">
                        <div class="col-md-4">
                            <label class=""><strong>Present Address</strong></label>
                            <textarea class="form-control" required="" name="pre_address" id="pre_address" rows="4" required><?php echo $formData["Present_address"] ?></textarea>
                        </div>
                        <div class="col-md-4">
                            <label class="checkbox-inline"><input class="" id="sameadd" name="sameadd" type="checkbox" value="Sameadd" onchange="CopyAdd();"/>Check if Same as Present Address<br/></label>
                        </div>
                        <div class="col-md-4">
                            <label class=""><strong>Permanent Address</strong></label>
                            <textarea class="form-control required" required="" name="per_address" id="per_address" rows="4"><?php echo $formData["Permanent_address"] ?></textarea>
                        </div>
                    </div>
                    <div class="col-md-12 form-group">
                        <div class="col-md-4">
                            <label  name=""><strong>Hospital Name</strong></label>
                        ...
                        <div class="col-md-4 form-group ">
                            <!--<div class="form-group">-->
                            <label class="control-label"><strong>Delivery Type</strong></label><br>
                    ...
                    <div class="col-md-12 form-group">
                        <div class="col-md-4-1 form-group ">
                            <!--<div class="form-group">-->
                            <label class="control-label"><strong>Religion-<?php echo $formData["Religion"] ?></strong></label><br>
                            <?php 
                            if(!empty($formData["Religion"])){
                                ...
                                $muslim = ($formData["Religion"] == "muslim")?"<label class='control-label radio-inline'><input type='radio' size='' name='religion' checked='' class=' ' id='muslim' value='muslim' >Muslim</label>":"<label class='control-label radio-inline'><input type='radio' size='' name='religion' class=' ' id='muslim' value='muslim' >Muslim</label>";
                                ...
                                $other = ($formData["Religion"] == "other")?"<label class='control-label radio-inline'><input type='radio' size='' name='religion' class=' ' checked='' id='others' value='other'>Others</label>":"<label class='control-label radio-inline'><input type='radio' size='' name='religion' class=' ' id='others' value='other'>Others</label>";
                        ...
                        <div class="col-md-2-2 form-group ">
                            <!--<div class="form-group">-->
                            
                            <label class="control-label"><strong>Caste</strong></label><br>
                            <?php 
                                if(!empty($formData["Caste"])){
                                    $st = ($formData["Caste"] == "st")?"<label class='control-label radio-inline'><input type='radio' size='' name='caste' checked='' class=' ' id='st' value='st'>ST</label>":"<label class='control-label radio-inline'><input type='radio' size='' name='caste' class=' ' id='st' value='st'>ST</label>";
                                    $sc = ($formData["Caste"] == "sc")?"<label class='control-label radio-inline'><input type='radio' size='' name='caste' checked='' class=' ' id='sc' value='sc' >SC</label>":"<label class='control-label radio-inline'><input type='radio' size='' name='caste' class=' ' id='sc' value='sc' >SC</label>";
                        ...
                        <div class="col-md-4-1 form-group ">
                            <!--<div class="form-group">-->
                            <label class="control-label"><strong>Socio-Economic status(Income):</strong></label><br>
                            <?php
                    ...
                    <div class="col-md-12 form-group">
                        <div class="col-md-4 form-group">
                            <label class="control-label"><strong>Any Medical History</strong></label>
                        ...
                        <div class="col-md-4 ">
                            <label  name=""><strong>Date of Screening</strong></label>
                    ...
                    <button id="patSubmit" class="btn btn-primary nextBtn btn-lg pull-right" type="button" >Next</button>
                </div>
            ...
            <div class="row setup-content" id="step-2">
                <div class="col-xs-12 col-md-offset-1">
                    <div class="col-md-12">
                        <h3> Screening Test1-<?php $formData1["hrr_type"] ?></h3>
                        <div class="col-md-12 subscribeGroup" >
                            <?php $hrrPresentChk = ($formData1["hrr_type"] == 1)?"checked=''":""; 
                                $presenceShow = ($formData1["hrr_type"] == 1)?"":"display: none"; 
                                
                            ?>
                            
                            
                                <div class="col-md-5 col-md-offset-1 form-group ">
                                    <label class="control-label radio hrr1"><input type="radio" size="" name="subscribe" required="" onclick="ShowhideHRR()" <?php echo $hrrPresentChk ?> class="subscribe restabsence" value="1" id="pesenceid" >Presence of HRR</label>
                                </div>
                            
                            <?php $hrrAbsentChk = ($formData1["hrr_type"] == 2)?"checked=''":""; 
                            ?>
                            <div class="col-md-5 col-md-offset-1 form-group pull-right ">
                                <label class="control-label radio-inline hrr2"><input type="radio" size="" name="subscribe" required="" class="ssubscribe" <?php echo $hrrAbsentChk ?> value="2" id="absencehrr" onclick="hideHrr()" >Absence of HRR</label>
                            </div>
                           
                            <?php //} ?>
                        </div>
                        <?php //$conditionally_load = (!empty($patientId))? "conditionally-loaded":"conditionally-loaded " ?>
                        <div class="col-md-12 <?php //echo $conditionally_load ?>" id="prenatalDv" style="<?php echo $presenceShow ?>">
                            <div class="col-md-2 col-md-offset-1 " style="background-color: rgba(0, 178, 0, 0.3);">
                                <?php $preNatalCheck = ($formData1["prenatal_hrr"] == 1)?"checked=''":""; 
                                      $prenataShow = ($formData1["prenatal_hrr"] == 1)?"":"display: none";  
                                        ?>
                                    <label class='control-label checkbox-inline hrr1'><input type='checkbox' size='' name='subscribe1' class='restabsence' <?php echo $preNatalCheck ?> id='prenatalhrr' value='1' >Pre Natal HRR</label>
                                    
                            </div>
                            <div class="col-md-2 col-md-offset-1 " style="background-color: rgba(22, 91, 168, 0.35);">
                                <?php $natalCheck = ($formData1["natal_hrr"] == 1)?"checked=''":""; 
                                      $natalShow = ($formData1["natal_hrr"] == 1)?"":"display: none";  
                                ?>
                                <label class='control-label checkbox-inline hrr1'><input type='checkbox' size='' name='subscribe2' class='restabsence '  id='natalhrr' <?php echo $natalCheck ?> value='1' > Natal HRR</label>
                            ...
                            <div class="col-md-3 col-md-offset-1 " style="background-color: rgba(245, 59, 38, 0.42);">
                                <?php $postNatalCheck = ($formData1["postnatal_hrr"] == 1)?"checked=''":""; 
                                      $postNatalShow = ($formData1["postnatal_hrr"] == 1)?"":"display: none";  
                                ?>
                                <label class='control-label checkbox-inline hrr1'><input type='checkbox' size='' name='subscribe3' class='restabsence ' <?php echo $postNatalCheck ?> id='postnatalhrr' value='1' >Post Natal HRR</label>
                            ...
                            <div class="col-md-2 col-md-offset-1 " style="background-color: rgba(255, 255, 0, 0.49);">
                                <?php $otherCheck = ($formData1["other_hrr"] == 1)?"checked=''":""; 
                                      $otherShow = ($formData1["other_hrr"] == 1)?"":"display: none";  
                                ?>
                                
                                <label class="control-label checkbox-inline hrr1"><input type="checkbox" size="" name="subscribe4" class="restabsence "  <?php echo $otherCheck ?> id="otherhrr" value="1" >Others HRR</label>
                            </div>
                        </div>
                        <div class="col-md-12" id="preDv">
                            <?php// $conditionallyLoad1 = ($formData1["hrr_type"] == 2  )?"conditionally-loaded1":"" ?>
                            <div class="col-md-2 col-md-offset-1 <?php //echo $conditionallyLoad1 ?>" id="prenatalDiv" style="background-color: rgba(0, 178, 0, 0.3); <?php echo $prenataShow ?>" >
                                <div class="col-md-12" style="">
                                    <?php $excVomit = ($formData1["excessive_vomiting"] == 1)? "<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='exvomit' class='restabsence ' checked=''  id='exvomit' value='1' >Excessive Vomiting</label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='exvomit' class='restabsence '  id='exvomit' value='1' >Excessive Vomiting</label>";  
                                          echo $excVomit;  
                                    ?>
                                    ...
                                    <?php $eld_pregnancy = ($formData1["elderly_pregnanacy"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='eldpreg' class='restabsence ' checked = '' id='eldpreg' value='1' >Elderly Pregnancy</label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='eldpreg' class='restabsence '  id='eldpreg' value='1' >Elderly Pregnancy</label>" ;
                                            echo $eld_pregnancy;
                                            ?>
                                    ...
                                    <?php $highLowBp = ($formData1["highlow_bp"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='bp' class='restabsence ' checked=''  id='bp' value='1'>High/Low B.P</label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='bp' class='restabsence '  id='bp' value='1'>High/Low B.P</label>"; 
                                        echo $highLowBp;
                                    ?>
<!--                                    <label class="control-label checkbox hrr1"><input type="checkbox" size="" name="bp" class=" "  id="bp" value="1">High/Low B.P</label>-->
                                    <?php $bloodSugr = ($formData1["blood_sugar"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='bloodsugar' class='restabsence '  id='bloodsugar' checked='' value='1'>Blood sugar</label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='bloodsugar' class='restabsence '  id='bloodsugar' value='1'>Blood sugar</label>"; 
                                        echo $bloodSugr;
                                    ?>
<!--                                    <label class="control-label checkbox hrr1"><input type="checkbox" size="" name="bloodsugar" class=" "  id="bloodsugar" value="1">Blood sugar</label>-->
                                    <?php $ho_abortions = ($formData1["ho_abortions"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='abortion' class='restabsence '  id='abortion' checked=''  value='1'>H/O abortion</label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='abortion' class='restabsence '  id='abortion'  value='1'>H/O abortion</label>"; 
                                        echo $ho_abortions;
                                    ?>
<!--                                    <label class="control-label checkbox hrr1"><input type="checkbox" size="" name="abortion" class=" "  id="abortion"  value="1">H/O abortion</label>-->
                                    <?php $rh_incompatitlibility = ($formData1["rh_incompatitlibility"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='rh' class='restabsence '  id='rh' checked='' value='1' >Rh Incompatibility</label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='rh' class='restabsence '  id='rh' value='1' >Rh Incompatibility</label>"; 
...
<!--                                    <label class="control-label checkbox hrr1"><input type="checkbox" size="" name="rh" class=" "  id="rh" value="1" >Rh Incompatibility</label>-->
                                    <?php $viralbacterial_infections = ($formData1["viralbacterial_infections"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='viralinfection' class='restabsence '  id='viralinfection' checked='' value='1' >Viral/Bacterial Infections</label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='viralinfection' class='restabsence '  id='viralinfection' value='1' >Viral/Bacterial Infections</label>"; 
...
<!--                                    <label class="control-label checkbox hrr1"><input type="checkbox" size="" name="viralinfection" class=" "  id="viralinfection" value="1" >Viral/Bacterial Infections</label>-->
                                    <?php $infections = ($formData1["infection"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='inection' class='restabsence '  id='infection' checked='' value='1' >Infection</label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='inection' class='restabsence '  id='infection' value='1' >Infection</label>"; 
                                        echo $infections;
                                    ?>
<!--                                    <label class="control-label checkbox hrr1"><input type="checkbox" size="" name="inection" class=" "  id="infection" value="1" >Infection</label>-->
                                    <?php $oto_tox_med = ($formData1["oto_tox_med"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='otomedication' checked='' class='restabsence'  id='otomedication' value='1' >Oto toxic medications</label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='otomedication' class='restabsence'  id='otomedication' value='1' >Oto toxic medications</label>"; 
                                        echo $oto_tox_med;
                                    ?>
                                    ...
                                    <?php $chem_fum = ($formData1["chem_fum"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='chemfume' class='restabsence '  id='chemfume' checked='' value='1'>Chemical fumes </label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='chemfume' class='restabsence '  id='chemfume' value='1'>Chemical fumes </label>"; 
                                        echo $chem_fum;
                                    ?>
<!--                                    <label class="control-label checkbox hrr1"><input type="checkbox" size="" name="chemfume" class=" "  id="chemfume" value="1">Chemical fumes </label>-->
                                    <?php $alcohol = ($formData1["alcohol"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='alcohol' class='restabsence '  id='alcohol' checked='' value='1' >Alcohol</label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='alcohol' class='restabsence '  id='alcohol' value='1' >Alcohol</label>"; 
                                        echo $alcohol;
                                    ?>
                                    <!--<label class="control-label checkbox hrr1"><input type="checkbox" size="" name="alcohol" class=" "  id="alcohol" value="1" >Alcohol</label>-->
                                    <?php $smoking = ($formData1["smoking"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='smoke' class='restabsence '  id='smoke' checked='' value='1' >Smoking </label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='smoke' class='restabsence '  id='smoke' value='1' >Smoking </label>"; 
                                        echo $smoking;
                                    ?>
<!--                                    <label class="control-label checkbox hrr1"><input type="checkbox" size="" name="smoke" class=" "  id="smoke" value="1" >Smoking </label>-->
                            ...
                            <div class="col-md-2 col-md-offset-1 <?php// echo $conditionallyLoad2 ?>" id="natalDiv" style="background-color: rgba(22, 91, 168, 0.35);<?php echo $natalShow ?>">
                                <div class="col-md-12 resetnatal">
                                    <?php $lbw = ($formData1["lbw"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='weightless' class='group_ctrl restabsence' data-group='group_a'  id='weightless' checked='' value='1'>Low Birth Weight<1.5kgs</label>
                                    <p>Birth Weight<input type='text' name='birth_wt' id='birth_wt' style='width:50px' class='group_a restabsencetxt' value='{$formData1["birth_wt"]}'>&nbsp; Kg</p> ":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='weightless' class='group_ctrl restabsence' data-group='group_a'  id='weightless' value='1'>Low Birth Weight<1.5kgs</label>
                                    <p>Birth Weight<input type='text' name='birth_wt' class='group_a restabsencetxt' id='birth_wt' style='width:50px' disabled='' value=''>&nbsp; Kg</p> "; 
                                        echo $lbw;
                                    ?>
<!--                                    <label class="control-label checkbox hrr1"><input type="checkbox" size="" name="weightless" class=" "  id="weightless" value="1">Low Birth Weight<1.5kgs</label>
                                    ...
                                    <?php $nj = ($formData1["nj"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='jaundice' id='jaundice' checked='' class='group_ctrl restabsence' data-group='group_b' value='1' >Neonatal Jaundice</label>
                                    <p>Bilrubin Level<input type='text' style='width:50px' name='bil_level' id='bil_level' class='group_b restabsencetxt' value='{$formData1["bilrubin_level"]}'></p> ":
                                        "<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='jaundice' id='jaundice' class='group_ctrl restabsence' data-group='group_b' value='1' >Neonatal Jaundice</label>
                                    <p>Bilrubin Level<input type='text' style='width:50px' name='bil_level'  id='bil_level' class='group_b restabsencetxt' disabled='' value=''></p> 
                                    ...
                                    <?php $delayBirthCry = (!empty($formData1["delayed_birth_cry"]))?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='dbcrychk' class='group_ctrl restabsence' data-group='group_c'  id='dbcrychk' checked='' value='1'>Delayed birth Cry</label>
                                    <p><input type='text' name='birthCry' id='birthCry' style='width:50px' class='group_c restabsencetxt' value='{$formData1["birthcrysec"]}'>&nbsp; Sec</p> ":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='dbcrychk' class='group_ctrl restabsence' data-group='group_c'  id='dbcrychk' value='1'>Delayed birth Cry</label>
                                    <p><input type='text' name='birthCry' class='group_c restabsencetxt' id='birthCry' style='width:50px' disabled='' value=''>&nbsp; Sec</p> "; 
                                        echo $delayBirthCry;
                                    ?>
                                    <?php $prematureDel = (!empty($formData1["premature_delivery_week"]))?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='pdwchk' class='group_ctrl restabsence' data-group='group_d'  id='pdwchk' checked='' value='1'>Premature delivery</label>
                                    <p><input type='text' name='prematuredel' id='prematuredel' style='width:50px' class='group_d restabsencetxt' value='{$formData1["premature_delivery_val"]}'>&nbsp; Days</p> ":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='pdwchk' class='group_ctrl restabsence' data-group='group_d'  id='pdwchk' value='1'>Premature Delivery</label>
                                    <p><input type='text' name='prematuredel' class='group_d restabsencetxt' id='prematuredel' style='width:50px' disabled='' value=''>&nbsp; Week</p> "; 
                                        echo $prematureDel;
                                    ?>
<!--                                    <label class="control-label checkbox hrr1"><input type="checkbox" size="" name="jaundice" class=" "  id="jaundice" value="1" >Neonatal Jaundice</label>
                                    ...
                                    <p>Delayed birth Cry<input type="text" name="birthcry" id="birthcry" style="width:50px" value="">&nbsp;Sec</p> 
                                    <p>Premature Delivery<input type="text" name="prematuredel" id="prematuredel" style="width:50px" value="">&nbsp;Week</p> -->
                                    <?php $ba = ($formData1["ba"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='birthasphyxia' class='restabsence'  id='birthasphyxia' checked=''  value='1' > Birth asphyxia </label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='birthasphyxia' class='restabsence'  id='birthasphyxia' value='1' > Birth asphyxia </label>"; 
                                        echo $ba;
                                    ?>
                                    ...
                                    <?php $fd = ($formData1["fd"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='fetaldistress' class='restabsence'  id='fetaldistress' checked='' value='1' > Fetal Distress </label>
                                     ":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='fetaldistress' class='restabsence'  id='fetaldistress' value='1' > Fetal Distress </label> "; 
                                        echo $fd;
                                    ?>
                                    <?php $aaf = ($formData1["aspiration_of_fluid_days"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='aafchk' class='restabsence'  id='aafchk' checked='' value='1' > Aspirations of amniotic fluid  </label>
                                     ":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='aafchk' class='restabsence'  id='aafchk' value='1' >Aspirations of amniotic fluid  </label> "; 
                                        echo $aaf;
                                    ?>
                                   <?php $nicu = (!empty($formData1["nicu"]))?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='nicuchk' class='group_ctrl restabsence' data-group='group_e'  id='nicuchk' checked='' value='1'>NICU</label>
                                    <p><input type='text' name='nicu' id='nicu' style='width:50px' class='group_e restabsencetxt' value='{$formData1["nicu_val"]}'>&nbsp; Week</p> ":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='nicuchk' class='group_ctrl restabsence' data-group='group_e'  id='nicuchk' value='1'>NICU</label>
                                    <p><input type='text' name='nicu' class='group_e restabsencetxt' id='nicu' style='width:50px' disabled='' value=''>&nbsp; days</p> "; 
                                        echo $nicu;
                                    ?>
<!--                                    <label class="control-label checkbox hrr1"><input type="checkbox" size="" name="fetaldistress" class=""  id="fetaldistress" value="1" > Fetal Distress </label>
                                    ...
                                    <?php $as_1min = ($formData1["as_1min"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='' class='restabsence' name='apgarone' id='apgarone' checked='' value='1' > APGAR Score:0-4@ 1min </label> ":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='' class='restabsence' name='apgarone' id='apgarone' value='1' > APGAR Score:0-4@ 1min </label> "; 
                                        echo $as_1min;
                                    ?>
<!--                                    <label class="control-label checkbox hrr1"><input type="checkbox" size="" name="" class="" name="apgarone" id="apgarone" value="1" > APGAR Score:0-4@ 1min </label>-->
                                    <?php $as_5min = ($formData1["as_5min"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='apgarfive' class='restabsence'  id='apgarfive' checked='' value='1' > APGAR Score:0-6@ 5mins </label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='apgarfive' class='restabsence'  id='apgarfive' value='1' > APGAR Score:0-6@ 5mins </label>"; 
                                        echo $as_5min;
                                    ?>
                            ...
                            <div class="col-md-3 col-md-offset-1 <?php// echo $conditionallyLoad3 ?>" id="postnatalDiv" style="background-color: rgba(245, 59, 38, 0.42); <?php echo $postNatalShow ?>">
                                <div class="col-md-12">
                                    <?php $csa = ($formData1["csa"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='craniofacial' class='restabsence '  id='craniofacial' checked='' value='1' >Craniofacial/structural anamolies</label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='craniofacial' class='restabsence '  id='craniofacial' value='1' >Craniofacial/structural anamolies</label>"; 
                                        echo $csa;
                                    ?>
                                    ...
                                    <?php $ca = ($formData1["ca"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='cogenital' class='restabsence '  id='cogenital' checked='' value='1' >Cogenital anomalies</label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='cogenital' class='restabsence '  id='cogenital' value='1' >Cogenital anomalies</label>"; 
                                        echo $ca;
                                    ?>
<!--                                    <label class="control-label checkbox hrr1"><input type="checkbox" size="" name="cogenital" class=" "  id="cogenital" value="1" >Cogenital anomalies</label>-->
                                    <?php $dd = ($formData1["dd"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='degenerative' class='restabsence '  id='degenerative' checked='' value='1' >Degenerative Diseases</label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='degenerative' class='restabsence '  id='degenerative' value='1' >Degenerative Diseases</label>"; 
                                        echo $dd;
                                    ?>
                                    ...
                                    <?php $vbf = ($formData1["vbf"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='viralinfect' class='restabsence '  id='viralinfect' checked='' value='1' >Viral/Bacterial Infections</label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='viralinfect' class='restabsence '  id='viralinfect' value='1' >Viral/Bacterial Infections</label>"; 
                                        echo $vbf;
                                    ?>
<!--                                    <label class="control-label checkbox hrr1"><input type="checkbox" size="" name="viralinfect" class=" "  id="viralinfect" value="1" >Viral/Bacterial Infections</label>-->
                                    <?php $cnv = ($formData1["cnv"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='convulsions' class='restabsence '  id='convulsions' cheked=''  value='1'>Convulsions</label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='convulsions' class='restabsence '  id='convulsions'  value='1'>Convulsions</label>"; 
                                        echo $cnv;
                                    ?>
<!--                                    <label class="control-label checkbox hrr1"><input type="checkbox" size="" name="convulsions" class=" "  id="convulsions"  value="1">Convulsions</label>-->
                                    <?php $omwe = ($formData1["omwe"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='otitis' class='restabsence '  id='otitis' checked='' value='1' >Otitis Media with effusion </label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='otitis' class='restabsence '  id='otitis' value='1' >Otitis Media with effusion </label>"; 
                                        echo $omwe;
                                    ?>
                                    ...
                                    <?php $thn = ($formData1["thn"] == 1)?"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='trauma' class='restabsence '  id='trauma' cheked='' value='1'>Trauma_of_head_or_neck </label>":"<label class='control-label checkbox hrr1'><input type='checkbox' size='' name='trauma' class='restabsence '  id='trauma' value='1'>Trauma_of_head_or_neck </label>"; 
                                        echo $thn;
                                    ?>
<!--                                    <label class="control-label checkbox hrr1"><input type="checkbox" size="" name="trauma" class=" "  id="trauma" value="1">Trauma_of_head_or_neck </label>-->
                            ...
                            <div class="col-md-2 col-md-offset-1" id="otherDiv" style="background-color: rgba(255, 255, 0, 0.49);<?php echo $otherShow ?>">
                                <div class="col-md-12">
                                    <h5>Consanguinity</h5>
                                    
                                    <p class="">
                                        <?php $cons_pos_val = ($formData1["cons_pos_val"] == 1)?"<input type='radio' size='' name='pos1' id='posRadio' class='restabsence' checked='' onchange='ShowHideHrr()' value='1'>Positive &nbsp ":"<input type='radio' size='' name='pos1' class='restabsence' id='posRadio' onchange='ShowHideHrr()' value='1'>Positive &nbsp"; 
                                            echo $cons_pos_val;
                                        ?>
                                        <?php $cons_neg_val = ($formData1["cons_neg_val"] == 1)?"<input type='radio' size='' name='pos1' id='negRadio' class='restabsence' checked='' onchange='ShowHideHrr()' value='2'  >Negative</p> ":"<input type='radio' size='' name='pos1' id='negRadio' class='restabsence' value='2' onclick='ShowHideHrr()'  >Negative</p>"; 
                                            echo $cons_neg_val;
                                        ?>
<!--                                        <input type="radio" size="" name="pos1" id="posRadio" onchange="ShowHideHrr()" value="1">Poositive &nbsp 
                                    ...
                                    ?>
                                    <p id="poscheck" style="">(<input type="radio" name="rad123" <?php echo $oneChk ?> class="restabsence" id="hrr1" value="1" >1, <input type="radio" class="" <?php echo $twoChk ?> name="rad123" id="hrr2" class='restabsence' value="1" >2, <input type="radio" class="restabsence" <?php echo $threeChk; ?> value="1" name="rad123" id="hrr3" >3 degree)</p>
                                    <?php }else{ ?>    
                                    <p id="poscheck" style="display: none">(<input type="radio" name="rad123" id="hrr1"  class="restabsence" value="1" >1, <input type="radio" name="rad123" id="hrr2" class="restabsence" value="1" >2, <input type="radio" value="1" name="rad123" class="restabsence" id="hrr3" >3 degree)</p>
                                    <?php } ?>
                                    <h5>Family History</h5>
                                    <p class="">
                                        <?php $family_his_poschk = ($formData1["fam_his_pos"] == 1)?"<input type='radio' size='' class='restabsence' name='pos2' onchange='ShowHideFamily()' value='1' id='posRadioFamily' checked=''>Positive &nbsp":"<input type='radio' size='' class='restabsence' name='pos2' value='1' id='posRadioFamily' onchange='ShowHideFamily()'>Positive &nbsp "; 
                                            echo $family_his_poschk;
                                        ?>
                                        <?php $family_his_negchk = ($formData1["fam_his_neg"] == 1)?"<input type='radio' size='' name='pos2' onchange='ShowHideFamily()' value='2' id='negRadioFamily' class='restabsence' checked='' >Negative":"<input type='radio' size='' class='restabsence' name='pos2' value='2' id='negRadioFamily' onclick='ShowHideFamily()'  >Negative"; 
...
<!--                                        <input type="radio" size="" name="pos2" value="1" id="posRadioFamily" onchange="ShowHideFamily()">Poositive &nbsp -->
                                    ...
                                    ?>
                                    <p id="poscheckFamily" style="">(<input type="radio" <?php echo $fam_his_mat ?> name="matpat" class="restabsence" id="maternal" value="1" >Maternal, <input type="radio" value="1" <?php echo $fam_his_pat; ?> name="matpat" class="restabsence" id="paternal" >Paternal)<br>(<input type="radio" name="radpos" class="restabsence" id="hi" <?php echo $fam_his_hi; ?> value="1" >HI, <input type="radio" name="radpos" class="restabsence" <?php echo $fam_his_sp ?> id="sp" value="1" > Sp, <input type="radio" <?php echo $fam_his_lg ?> value="1" class="restabsence" name="radpos" id="lg" > Lg, <input type="radio" class="restabsence" name="radpos" id="md" <?php echo $fam_his_md ?> value="1" > MD, <input type="radio" name="radpos" class="restabsence" id="othr" <?php echo $fam_his_oth ?> value="1" > Other)</p>
                                    <?php } else{ ?>
                                    <p id="poscheckFamily" style="display: none">(<input type="radio" name="matpat" class="restabsence" id="maternal" value="1" >Maternal, <input type="radio" value="1" class="restabsence" name="matpat" id="paternal" >Paternal)<br>(<input type="radio" name="radpos" class="restabsence" id="hi" value="1" >HI, <input type="radio" name="radpos" class="restabsence" id="sp" value="1" > Sp, <input type="radio" value="1" class="restabsence" name="radpos" id="lg" > Lg, <input type="radio" name="radpos" class="restabsence" id="md" value="1" > MD, <input type="radio" name="radpos" class="restabsence" id="othr" value="1" > Other)</p>
                                    <?php  } ?>
                                </div>
...
<label class="control-label checkbox hrr1"><input type="checkbox" size="" name="" class=" "  id="" >Pre Natal HRR</label>-->
                        ...
                        <div id="hrrdet">
                            <input type='text' name='hrr_id' id='hrr_id' hidden="" value='<?php echo $formDataHrr["hrr_id"] ?>'>
                            <input type='text' name='prenatal_id' id='prenatal_idval' hidden='' value='<?php echo $formData1["prenatal_id"];?>'>
                            ...
                            <input type='text' name='other_id' id='other_idval' hidden='' value='<?php echo $formData1["other_id"] ?>'>
                        </div>
                        <!--<button class="btn btn-primary nextBtn btn-lg pull-right" type="button" onclick="hrrscreen();" >Next</button>-->
                        <button class="btn btn-primary nextBtn btn-lg pull-right" type="button" id="hrrSubmit" >Next</button>
                    </div>
                </div>
            </div>
            <div class="row setup-content" id="step-4">
                <div class="col-xs-12 ">
                    <div class="sorting-title col-md-3" >
                        <!--<div class="form-group">-->
                        <h4>Impression</h4>
                        <!--<input type="text" size="10" name="impRes" hidden="" class="form-control" readonly=""  id="" value="<?php echo $formData["test_impression"] ?>"  >-->
                        </div>
                    </div>
                    <div class="col-md-12" id="impresn">
                         <div class="sorting-title col-md-3 col-md-offset-1" >
                        <!--<div class="form-group">-->
                        <h4>Impression</h4>
                        <input type="text" size="10" name="impRes" hidden="" class="form-control" readonly=""  id="" value="<?php echo $formData["test_impression"] ?>"  >
                        </div>
            ...
            <div class="row setup-content" id="step-3">
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <h3>OAE Screening</h3>
                        <div class="row">
                            <div class="col-md-6 " style="background-color: rgba(0, 221, 28, 0.39);;">
                                <div class="col-md-12 col-md-offset-1">
                                    <h4 class="">1st Screening Test</h4>
                                    <?php 
                                            $firstScreenCheckTE = (!empty($formData2["screen_one_id"]) && $formData2["screen1_type"] == '1')?"checked=''":"" ;
                                            $firstScreenCheckDP = (!empty($formData2["screen_one_id"]) && $formData2["screen1_type"] == '2')?"checked=''":"" ;
                                           $display1Screen = ($formData2["screen1_type"] == 1 || $formData2["screen1_type"] == 2)?"":"display: none"; 
                                           $rtpasschk = ($formData2["rt_screen1"] == 1)?"checked=''":"";
                                           $rtrefrchk = ($formData2["rt_screen1"] == 2)?"checked=''":"";
                                           $rtcntchk = ($formData2["rt_screen1"] == 3)?"checked=''":"";
                                           $ltpasschk = ($formData2["lt_screen1"] == 1)?"checked=''":"";
                                           $ltrefrchk = ($formData2["lt_screen1"] == 2)?"checked=''":"";
                                           $ltcntchk = ($formData2["lt_screen1"] == 3)?"checked=''":"";
                                           
                                    ?>
                                    <div>
                                        <span><strong class=""><label class="control-label"><input type="radio" size="" onclick="ShowhideTeDp1()" name="oae"
                                        class="resetchk1 " <?php echo $firstScreenCheckTE; ?>  id="techk" value="1" >TEOAE</label>/<label class="control-label"><input type="radio" size="" onclick="ShowhideDpTe1()" name="oae" class="resetchk1 " <?php echo $firstScreenCheckDP; ?>  id="dpchk" value="2" >DPOAE</label></strong></span>
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><label class="control-label checkbox"><input type="radio" size="" name="oaertear" value="1" class="resetchk1 " <?php echo $rtpasschk ?>  id="oaertpass" >Pass</label></td>
                                                <td></td>
                                                <td class=""><label class="control-label checkbox"><input type="radio" size="" name="oaeltear" class="resetchk1"  id="oaeltpass" <?php echo $ltpasschk ?> value="1" >Pass</label></td>
                                            </tr>
                                            <tr>
                                                <td><label class="control-label checkbox"><input type="radio" size="" name="oaertear" class="resetchk1"  id="oaertrefer" <?php echo $rtrefrchk ?> value="2" >Refer</label></td>
                                                <td></td>
                                                <td class=""><label class="control-label checkbox"><input type="radio" size="" name="oaeltear" class="resetchk1 "  id="oaeltrefer" <?php echo $ltrefrchk ?> value="2">Refer</label></td>
                                            </tr>
                                            <tr>
                                                <td><label class="control-label checkbox"><input type="radio" size="" name="oaertear" id="oaertcnt" class="resetchk1 " <?php echo $rtcntchk ?>  id="" value="3" >CNT</label></td>
                                                <td></td>
                                                <td class=""><label class="control-label checkbox"><input type="radio" name="oaeltear" size="" class="resetchk1 "  id="oaeltcnt" <?php echo $ltcntchk ?> value="3" >CNT</label></td>
                                            </tr>
                                            <tr colspan="">
                                                <td colspan="3"><p>(<input type="radio" size="" name="oaenotcorp" class="resetchk1 "  id="oaenoisy" value="1" >Noisy&nbsp; &nbsp;<input type="radio" size="" name="oaenotcorp" class="resetchk1 "  id="oaenotcorp" value="2" >Not cooperative)</td>
                                            </tr>

                                        </tbody>
                                    </table>
                                    <div class="form-group">
                                        <input type="button" id="restchkBtn1" class="btn btn-default" value="Reset">
                                    </div>
                                </div>
                            </div>
                            <?php //$secondScreenCheck = (!empty($formData2["screen_two_id"]))?"checked=''":"" ;
                                   $secondScreenCheckTE = (!empty($formData2["screen_two_id"]) && $formData2["screen2_type"] == '1')?"checked=''":"" ;
                                    $secondScreenCheckDP = (!empty($formData2["screen_two_id"]) && $formData2["screen2_type"] == '2')?"checked=''":"" ;
                                    $display2Screen = ($formData2["screen2_type"] == 1 || $formData2["screen2_type"] == 2)?"":"display: none"; 
                                    $rtpasschk2 = ($formData2["rt_screen2"] == 1)?"checked=''":"";
                                    $rtrefrchk2 = ($formData2["rt_screen2"] == 2)?"checked=''":"";
                                    $rtcntchk2 = ($formData2["rt_screen2"] == 3)?"checked=''":"";
                                    $ltpasschk2 = ($formData2["lt_screen2"] == 1)?"checked=''":"";
                                    $ltrefrchk2 = ($formData2["lt_screen2"] == 2)?"checked=''":"";
                                    $ltcntchk2 = ($formData2["lt_screen2"] == 3)?"checked=''":"";
                                            
                                    ?>
                            <div class="col-md-6 " style="background-color: rgba(23, 143, 229, 0.22);;">
                                <div class="col-md-12 col-md-offset-1" >
                                    <div id="tedpchk2" >
                                        <h4 class="">2nd Screening Test</h4>
                                        <span><strong class=""  id=""><label class="control-label"><input type="radio" size="" onclick="ShowhideTeDp2()" name="oae2" class="resetChk2 "  id="techk2" <?php echo $secondScreenCheckTE; ?> value="1">TEOAE</label>/<label class="control-label"><input type="radio" size="" class="resetChk2" onclick="ShowhideDpTe2()" name="oae2" class=" "  id="dpchk2" <?php echo $secondScreenCheckDP; ?> value="2">DPOAE</label></strong></span>
                                    </div>
                                    <table class="footer__table" id="tedp2" style="<?php echo $display2Screen ; ?>">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><label class="control-label checkbox"><input type="radio" size="" name="oaertear2" class="resetChk2"  id="oaertpass2" <?php echo $rtpasschk2; ?> value="1" >Pass</label></td>
                                                <td></td>
                                                <td class=""><label class="control-label checkbox"><input type="radio" size="" name="oaeltear2" class="resetChk2"  id="oaeltpass2" <?php echo $ltpasschk2; ?> value="1" >Pass</label></td>
                                            </tr>
                                            <tr>
                                                <td><label class="control-label checkbox"><input type="radio" size="" name="oaertear2" class="resetChk2 "  id="oaertrefer2" <?php echo $rtrefrchk2; ?> value="2" >Refer</label></td>
                                                <td></td>
                                                <td class=""><label class="control-label checkbox"><input type="radio" size="" name="oaeltear2" class="resetChk2 "  id="oaeltrefer2" <?php echo $ltrefrchk2; ?> value="2">Refer</label></td>
                                            </tr>
                                            <tr>
                                                <td><label class="control-label checkbox"><input type="radio" size="" name="oaertear2" class="resetChk2 "  id="oaertcnt2" <?php echo $rtcntchk2; ?> value="3" >CNT</label></td>
                                                <td></td>
                                                <td class=""><label class="control-label checkbox"><input type="radio" size="" name="oaeltear2" class="resetChk2 "  id="oaeltcnt2" <?php echo $ltcntchk2; ?> value="3" >CNT</label></td>
                                            </tr>
                                            <tr colspan="">
                                                <td colspan="3"><p>(<input type="radio" size="" name="oaenotcorp2" class="resetchk1 "  id="oaenoisy2" value="1" >Noisy&nbsp; &nbsp;<input type="radio" size="" name="oaenotcorp2" class="resetChk2"  id="oaenotcorp2" value="2" >Not cooperative)</td>
                                            </tr>

                                        </tbody>
                                    </table>
                                    <div class="form-group">
                                        <input type="button" id="restchkBtn2" class="btn btn-default" value="Reset">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <?php 
                                    ...
                                    ?>
                        <div class="row">
                            <div class="col-md-6" style="background-color: rgba(181, 84, 187, 0.33)">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <p><label class="control-label checkbox"><input type="radio" class="resetChk3" size="" name="500nbn" <?php echo $fivehz_80dBHL_pass ?> class=" "  id="nbn500pass1" value="1" >Pass</label></p>
                                                        <p><label class="control-label checkbox"><input type="radio" size="" class="resetChk3" name="500nbn" <?php echo $fivehz_80dBHL_refer  ?> class=" "  id="nbn500refer1" value="1" >Refer</label></p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p><label class="control-label checkbox"><input type="radio" size="" name="nbn500" class="resetChk3" <?php echo $fivehz_50dBHL_pass  ?>  id="nbn500pass2" value="1" >Pass</label></p>
                                                        <p><label class="control-label checkbox"><input type="radio" size="" name="nbn500" class="resetChk3" <?php echo $fivehz_50dBHL_refer  ?>  id="nbn500refer2" value="1" >Refer</label></p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center"><h6>4000Hz Warable tones/NBN</h6></td>
                                                    <td class="text-center">
                                                        <p><label class="control-label checkbox"><input type="radio" size="" name="nbn4000" class="resetChk3" id="nbn4000pass1" <?php echo $fourhz_80dBHL_pass ?> value="1" >Pass</label></p>
                                                        <p><label class="control-label checkbox"><input type="radio" size="" name="nbn4000" class="resetChk3"  id="nbn4000refer1" <?php echo $fourhz_80dBHL_refer ?> value="1" >Refer</label></p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p><label class="control-label checkbox"><input type="radio" size="" name="4000nbn" class="resetChk3"  id="nbn4000pass2" <?php echo $fourhz_50dBHL_pass ?> value="1" >Pass</label></p>
                                                        <p><label class="control-label checkbox"><input type="radio" size="" name="4000nbn" class="resetChk3"  id="nbn4000refer2" <?php echo $fourhz_50dBHL_refer ?> value="1" >Refer</label></p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center"><h6>White Noise</h6></td>
                                                    <td class="text-center">
                                                        <p><label class="control-label checkbox"><input type="radio" size="" name="whitenose1" class="resetChk3"  id="whitenoisypass1" <?php echo $whitenoise_80dBHL_pass ?> value="1" >Pass</label></p>
                                                        <p><label class="control-label checkbox"><input type="radio" size="" name="whitenose1" class="resetChk3"  id="whitenoisyrefer1" <?php echo $whitenoise_80dBHL_refer ?> value="1" >Refer</label></p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p><label class="control-label checkbox"><input type="radio" size="" name="whitenose2" class="resetChk3"  id="whitenoisypass2" <?php echo $whitenoise_50dBHL_pass ?> value="1" >Pass</label></p>
                                                        <p><label class="control-label checkbox"><input type="radio" size="" name="whitenose2" class="resetChk3"  id="whitenoisyrefer2" <?php echo $whitenoise_50dBHL_refer ?> value="1" >Refer</label></p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <div class="form-group">
                                            <input type="button" id="restchkBtn3" class="btn btn-default" value="Reset">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            ?>
                            <div class="col-md-6 " style="background-color: rgba(245, 172, 39, 0.35);">
                                <div class="col-md-offset-1">
                                    <div>
                                        ...
                                        <table class="footer__table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><label class="control-label checkbox"><input type="radio" size="" name="mororadio" class="resetChk4"  id="moropresent" <?php echo $moro_pre ?> value="1" >Present</label></td>
                                                    <td class=""><label class="control-label checkbox"><input type="radio" size="" name="mororadio" class="resetChk4 " <?php echo $moro_abs ?>  id="moroabsent" value="1" >Absent</label></td>
                                                </tr>
                                                <tr>
                                                    <td><h6>Rooting</h6></td>
                                                    <td><label class="control-label checkbox"><input type="radio" size="" name="rootingradio" class="resetChk4 "  id="rootingpresent" <?php echo $root_pre ?> value="1" >Present</label></td>
                                                    <td class=""><label class="control-label checkbox"><input type="radio" size="" name="rootingradio" class="resetChk4 "  id="rootingabsent" <?php echo $root_abs ?> value="1" >Absent</label></td>
                                                </tr>
                                                <tr>
                                                    <td><h6>Sucking</h6></td>
                                                    <td><label class="control-label checkbox"><input type="radio" size="" name="suckradio" class="resetChk4 "  id="suckpresent" <?php echo $suck_pre ?> value="1" >Present</label></td>
                                                    <td class=""><label class="control-label checkbox"><input type="radio" size="" name="suckradio" class="resetChk4 "  id="suckabsent" <?php echo $suck_abs  ?> value="1" >Absent</label></td>
                                                </tr>
                                                <tr>
                                                    <td><h6>Tonic neck</h6></td>
                                                    <td><label class="control-label checkbox"><input type="radio" size="" name="tonicradio" class="resetChk4 "  id="tonicpresent" <?php echo $tonicneck_pre ?> value="1" >Present</label></td>
                                                    <td class=""><label class="control-label checkbox"><input type="radio" size="" name="tonicradio" class="resetChk4 "  id="tonicabsent" <?php echo $tonicneck_abs ?> value="1" >Absent</label></td>
                                                </tr>
                                                <tr>
                                                    <td><h6>Palmar</h6></td>
                                                    <td><label class="control-label checkbox"><input type="radio" size="" name="palmarradio" class="resetChk4 "  id="palmarpresent" <?php echo $palmar_pre ?> value="1" >Present</label></td>
                                                    <td class=""><label class="control-label checkbox"><input type="radio" size="" name="palmarradio" class="resetChk4 "  id="palmarabsent" <?php echo $palmar_abs ?> value="1" >Absent</label></td>
                                                </tr>
                                                <tr>
                                                    <td><h6>Plantar</h6></td>
                                                    <td><label class="control-label checkbox"><input type="radio" size="" name="plantarradio" class="resetChk4 "  id="plantarpresent" <?php echo $plantar_pre ?> value="1" >Present</label></td>
                                                    <td class=""><label class="control-label checkbox"><input type="radio" size="" name="plantarradio" class="resetChk4 "  id="planterabsent" <?php echo $plantar_abs ?> value="1" >Absent</label></td>
                                                </tr>
                                                <tr>
                                                    <td><h6>Babinski</h6></td>
                                                    <td><label class="control-label checkbox"><input type="radio" size="" name="babinskiradio" class="resetChk4 "  id="babinskipresent" <?php echo $babinski_pre ?> value="1" >Present</label></td>
                                                    <td class=""><label class="control-label checkbox"><input type="radio" size="" name="babinskiradio" class="resetChk4 "  id="babinskiabsent" <?php echo $babinski_abs ?> value="1" >Absent</label></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <div class="form-group">
                                            <input type="button" id="restchkBtn4" class="btn btn-default" value="Reset">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            ?>
                            <div class="col-md-6 " style="background-color: rgba(255, 195, 0, 0.42)"> 
                                <div class="col-md-offset-1">
                                    <div>
                        ...
                        <?php $aabr_screen_chk = ($formData2["aabr_chk"] == 1)?"checked=''":"" ;
                                $aabrDisplay = ($formData2["aabr_chk"] == 1)?"":"display: none"; 
                         ...
                         ?>
                        <div class="row">
                            <div class="col-md-6 " style="background-color: rgba(255, 76, 0, 0.25);">
                                <div class=" col-md-offset-1">
                                    <div id="aabr">
                                        <h4 class="">Automated Auditory brain stem response (AABR) Screening</h4>
                                        <strong class="control-label checkbox"  id=""><input type="checkbox" size="" onclick="ShowhideAabr()" name="aabrchk" class=" " <?php echo $aabr_screen_chk ?>  id="aabrchk" value="1" >AABR</strong>
                                    </div>
                                    <table class="footer__table" id="aabrsc" style="<?php echo $aabrDisplay?>">
                                        <tbody>
                                            ...
                                            <tr colspan="">
                                                <td colspan="3"><p>(<input type="radio" size="" name="aabrnotcorp" class="resetchk1 "  id="aabrnoisy" value="1" >Noisy&nbsp; &nbsp;<input type="radio" size="" name="aabrnotcorp" class=""  id="aabrnotcorp" value="2" >Not cooperative)</td>
                                            </tr>
    ...
    $(document).ready(function () {
        ...
        allNextBtn.click(function () {
            var curStep = $(this).closest(".setup-content"),
                    ...
                    curInputs = curStep.find("input[type='text'],input[type='url'],textarea,input[type='radio']"),
                    isValid = true;
...
<script type="text/javascript">
    ...
    function ShowhideDpTe1() {
        var chkDpte = document.getElementById("dpchk");
        var tablDpTe = document.getElementById("tedp");
        //var tedpchk2 = document.getElementById("tedpchk2");
        tablDpTe.style.display = chkDpte.checked ? "block" : "none";
        //tedpchk2.style.display = chkTedp.checked ? "block" : "none";
    }
    ...
    function ShowhideDpTe2() {
        var chkdpTe2 = document.getElementById("dpchk2");
        var tabldpTe2 = document.getElementById("tedp2");
        //var aabr = document.getElementById("aabr");
        tabldpTe2.style.display = chkdpTe2.checked ? "block" : "none";
       // aabr.style.display = chkTedp2.checked ? "block" : "none";
    }
...
<script>
    function ShowhideHRR() {
        ...
        var DvHrr = document.getElementById("prenatalDv");
        //var DvPreHrr = document.getElementById("preDv");
        DvHrr.style.display = chkpresence.checked ? "block" : "none";
        //DvPreHrr.style.display = chkpresence.checked ? "block" : "none";
    }
    function hideHrr() {
        var chkAbsence = document.getElementById("absencehrr");
        var DvHrr = document.getElementById("prenatalDv");
        var DvPreNatal = document.getElementById("prenatalDiv");
        var DvNatal = document.getElementById("natalDiv");
        var DvPostNatal = document.getElementById("postnatalDiv");
        var DvOther = document.getElementById("otherDiv");
        DvHrr.style.display = chkAbsence.checked ? "none" : "block";
        DvPreNatal.style.display = chkAbsence.checked ? "none" : "";
        DvNatal.style.display = chkAbsence.checked ? "none" : "";
        DvPostNatal.style.display = chkAbsence.checked ? "none" : "";
        DvOther.style.display = chkAbsence.checked ? "none" : "";
    }
    $('#prenatalhrr').click(function(){
        $("#prenatalDiv").toggle(this.checked);
   
    });
    $('#natalhrr').click(function(){
        $("#natalDiv").toggle(this.checked);
   
    });
    $('#postnatalhrr').click(function(){
        $("#postnatalDiv").toggle(this.checked);
   
    });
    $('#otherhrr').click(function(){
        $("#otherDiv").toggle(this.checked);
   
    });

   
    $("#restchkBtn1").click(function(){
            $(".resetchk1").each(function(){
             $(this).prop("checked",false);
            });
      });
    $("#restchkBtn2").click(function(){
            $(".resetChk2").each(function(){
             $(this).prop("checked",false);
            });
      });
    $("#restchkBtn3").click(function(){
            $(".resetChk3").each(function(){
             $(this).prop("checked",false);
            });
      });
    $("#restchkBtn4").click(function(){
            $(".resetChk4").each(function(){
             $(this).prop("checked",false);
            });
      });
...
<!--<script type="text/javascript">
    ...
    var subscribeInput = $('input[name="subscribe"]');
   // var subscribeInput = $('.subscribe:checked');

    conditionalInput.hide();
    subscribeInput.on('click', function () {
        alert(subscribeInput);
        if ($(this).is(':checked'))
            conditionalInput.show();
        else
            conditionalInput.hide();
