...
<label class="control-label checkbox hrr1"><input type="checkbox" size="" name="" class=" "  id="" >Pre Natal HRR</label>-->
                        ...
                        <div id="hrrdet">
                            <input type='text' name='hrr_id' id='hrr_id' hidden='' value='<?php echo $formDataHrr["hrr_type"] ?>'>
                        ...
                        <div class="row">
                            <div class="col-md-5 " style="background-color: rgba(0, 221, 28, 0.39);;">
                                <div class="col-md-12 col-md-offset-1">
                                    ...
                                    ?>
                                    <span><strong class="control-label"><label class="control-label"><input type="radio" size="" onclick="ShowhideTeDp1()" name="oae" class=" " <?php echo $firstScreenCheck; ?>  id="techk" value="1" required="" >TEOAE</label>/<label class="control-label checkbox-inline"><input type="radio" size="" onclick="ShowhideDpTe1()" name="oae" class=" " <?php echo $firstScreenCheck; ?>  id="dpchk" value="2" required="">DPOAE</label></strong></span>
                            ...
                            <div class="col-md-5 " style="background-color: rgba(23, 143, 229, 0.22);;">
                                <div class="col-md-12 col-md-offset-1" >
                                    <div id="tedpchk2" >
                                        ...
                                        <span><strong class="control-label checkbox"  id=""><label class="control-label"><input type="radio" size="" onclick="ShowhideTeDp2()" name="techk2" class=" "  id="techk2" <?php echo $secondScreenCheck; ?> value="1">TEOAE</label>/<label class="control-label"><input type="radio" size="" onclick="ShowhideDpTe2()" name="techk2" class=" "  id="dpchk2" <?php echo $secondScreenCheck; ?> value="2">DPOAE</label></strong></span>
                                    </div>
